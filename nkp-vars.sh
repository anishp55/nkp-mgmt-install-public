...
export NUTANIX_PRISM_ELEMENT_CLUSTER_NAME=DM3-POC059
# NKP cluster subnet
...
export NUTANIX_ENDPOINT=10.55.47.7
export NUTANIX_PORT=9440
export CONTROL_PLANE_ENDPOINT_IP=${BASE_ADDRESS}.7
export LB_IP_RANGE=${BASE_ADDRESS}.8-${BASE_ADDRESS}.10
