...
export NUTANIX_ENDPOINT=10.8.50.7
...
export CONTROL_PLANE_ENDPOINT_IP=10.8.50.140

# Load balancer IP range. Format: <first_ip>-<last_ip>
# Check the table to find your IP
export LB_IP_RANGE=10.8.50.141-10.42.73.144
...
export IMAGES=/home/ubuntu/assets/nkp-v2.16.1/container-images/kommander-image-bundle-v2.16.1.tar,
export IMAGES+=/home/ubuntu/assets/nkp-v2.16.1/container-images/konvoy-image-bundle-v2.16.1.tar
